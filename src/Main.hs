...
body = tex $ do
  ...
  (#) na ni ga wow5 ko no so ra ni to do_ ku no da ro u eol
  (#) da ke do_ wow5 a shi ta no yo te i mo wa ka ra na i eol

  (#) eol

  let p1 = do
        (#) mu ge n da i na yu me no a to no na ni mo na i yo no na ka ja eol
        (#) so u sa i to shi i o mo i mo ma ke so u ni na ru ke do_ eol
  ...
  (#) do_ ko ma de mo ki mi ni a i ni yu ko u eol
  ...
  (#) da ke do_ wow5 ki ta i shi te te mo shi ka ta na i eol
